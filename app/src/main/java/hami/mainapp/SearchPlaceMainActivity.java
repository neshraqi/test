...
public class SearchPlaceMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            ToastMessageBar.show(this, com.hami.common.R.string.msgErrorPayment);
            finish();
        }
    ...
    private void setupPlace() {
        ...
        int hintString = (hasTakeOff) ? com.hami.common.R.string.flyingFrom : com.hami.common.R.string.flyingTo;
        autoCompleteFromPlace.setHint(hintString);
        switch (serviceId) {
            case ServiceID.SERVICE_ID_FLIGHT_DOMESTIC:
                headerBar.showMessageBar(com.hami.common.R.string.typeCityAndAirport);
            ...
            case ServiceID.SERVICE_ID_TRAIN:
                headerBar.showMessageBar(com.hami.common.R.string.typeCity);
        ...
        internationalApi.searchPlace(title, new SearchInternationalPresenter() {
            ...
            public void onError(final String msg) {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        ToastMessageBar.show(SearchPlaceMainActivity.this, com.hami.common.R.string.msgErrorPayment);
                    }
                });
            }
...
//        RecyclerView rvResult = (RecyclerView) findViewById(com.hami.common.R.id.rvResult);
//        rvResult.setHasFixedSize(true);
//        LinearLayoutManager layoutManager = new LinearLayoutManager(this);
//        rvResult.setLayoutManager(layoutManager);
