package hami.mainapp.train.Adapter;
...
import hami.mainapp.train.Services.Controller.Model.CityTrain;
...
public class SearchPlaceTrainAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = null;
        //LayoutInflater.from(parent.getContext()).inflate(R.layout.row_search_items_place_new, null);
        if (viewType == CityTrain.HEADER) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, final int position) {
        ...
        if (city.getType() == CityTrain.CITY) {
