package hami.mainapp.hotel.Domestic;
...
import com.hami.common.Util.UtilActionCall;
...
import hami.mainapp.hotel.Domestic.Adapter.DomesticHotelSlidingImageAdapter;
import hami.mainapp.hotel.Domestic.Controller.DomesticHotelApi;
import hami.mainapp.hotel.Domestic.Controller.Model.DomesticHotelBookingProcessData;
...
import hami.mainapp.hotel.Domestic.Controller.Model.DomesticHotelRoom;
    ...
    View.OnClickListener onClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            if (v.getId() == R.id.btnFullFeatures)
                UtilFragment.addNewFragment(getActivity().getSupportFragmentManager(), FragmentFullDetailDomesticHotel.newInstance(domesticHotelDetailsResponse), R.id.frame_Layout);
        }
    };
            ...
            public void onSuccessResultSearch(final DomesticHotelPreBookingResponse result) {
                if (getActivity() != null) {
                    getActivity().runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            UtilFragment.addNewFragment(getActivity().getSupportFragmentManager(), FragmentPassengerDomesticHotel.newInstance(result, domesticHotelPreBooking), R.id.frame_Layout);
                        }
                    });
                }
            }
