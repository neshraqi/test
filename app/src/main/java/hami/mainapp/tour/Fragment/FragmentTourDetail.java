...
import com.hami.common.BaseController.NameValueBoolean;
...
import com.hami.common.View.TextToggleView;
import com.hami.common.View.ToastMessageBar;
import com.hami.common.View.ToolsTourOption;

import hami.mainapp.R;
import hami.mainapp.tour.Adapter.TourSlidingImageAdapter;
    ...
    View.OnClickListener onClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            if (v.getId() == R.id.btnRegister) {
                UtilFragment.addNewFragment(getActivity().getSupportFragmentManager(), FragmentTourAddPassenger.newInstance(tourDetailData), R.id.frame_Layout);
            }
