...
public class TicketInternational implements Parcelable {
    ...
    private hami.mainapp.flight.Services.International.Controller.Model.RegisterPassengerResponse RegisterPassengerResponse;
    //-----------------------------------------------
    ...
    public TicketInternational(OutBound outBound, OutBound return_, hami.mainapp.flight.Services.International.Controller.Model.RegisterPassengerResponse registerPassengerResponse) {
    ...
    public hami.mainapp.flight.Services.International.Controller.Model.RegisterPassengerResponse getRegisterPassengerResponse() {
