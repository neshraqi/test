...
import hami.mainapp.flight.Services.International.Adapter.NewInternationalListAdapter;
...
import hami.mainapp.flight.Services.International.Controller.Model2.AllFlightInternationalResponse;
...
import hami.mainapp.flight.Services.International.Controller.Presenter.InternationalApi2;
import hami.mainapp.flight.Services.International.Dialog.NewDesignFilterFlightInternationalFragmentDialog;
        ...
        public void onSelectItem(Object object, int index) {
            if (object instanceof AllFlightInternationalParto) {
                UtilFragment.addNewFragment(getActivity().getSupportFragmentManager(),
                        FragmentInternationalDetails.newInstance((AllFlightInternationalParto) object, packageCompletedFlightInternational), R.id.frame_Layout);
            } else if (object instanceof FinalFlightInternationalIati) {
                UtilFragment.addNewFragment(getActivity().getSupportFragmentManager(),
                        FragmentInternationalDetails.newInstance((FinalFlightInternationalIati) object, packageCompletedFlightInternational), R.id.frame_Layout);
            } else if (object instanceof AllFlightInternationalIati) {
                UtilFragment.addNewFragment(getActivity().getSupportFragmentManager(),
                        FragmentInternationalDetails.newInstance((AllFlightInternationalIati) object, packageCompletedFlightInternational), R.id.frame_Layout);
            }
