package hami.mainapp.flight.Services.International.Fragment;
...
import hami.mainapp.flight.Services.International.Adapter.PassengerInfoListAdapter;
import hami.mainapp.flight.Services.International.Controller.Model.RegisterPassengerResponse;
import hami.mainapp.flight.Services.International.Controller.Model.ReserveRequest;
import hami.mainapp.flight.Services.International.Controller.Model.TicketInternational;
import hami.mainapp.flight.Services.International.Controller.Model2.AllFlightInternationalIati;
import hami.mainapp.flight.Services.International.Controller.Model2.AllFlightInternationalParto;
import hami.mainapp.flight.Services.International.Controller.Model2.FinalFlightInternationalIati;
import hami.mainapp.flight.Services.International.Controller.Model2.PackageCompletedFlightInternational;
import hami.mainapp.flight.Services.International.Controller.Model2.ResultRegisterFlightInternationalResponse;
import hami.mainapp.flight.Services.International.Controller.Model2.ResultRegisterPassengerFlightInternationalResponse;
import hami.mainapp.flight.Services.International.Controller.Model2.RulesRequest;
import hami.mainapp.flight.Services.International.Controller.Presenter.InternationalApi;
import hami.mainapp.flight.Services.International.Controller.Presenter.ReserveInternationalPresenter;
...
//            txtReturnFlightTime.setText(" زمان پرواز:" + timeTakeOffReturn);
    ...
    private void showRulesPartoWent(RulesRequest rulesRequest, AllFlightInternationalParto allFlightInternationalParto) {
        UtilFragment.addNewFragment(getActivity().getSupportFragmentManager(),
                FragmentInternationalRouting.newInstance(allFlightInternationalParto, false, packageCompletedFlightInternational, rulesRequest), R.id.frame_Layout);
    }

    //-----------------------------------------------
    private void showRulesPartoReturn(RulesRequest rulesRequest, AllFlightInternationalParto allFlightInternationalParto) {
        UtilFragment.addNewFragment(getActivity().getSupportFragmentManager(),
                FragmentInternationalRouting.newInstance(allFlightInternationalParto, true, packageCompletedFlightInternational, rulesRequest), R.id.frame_Layout);
    }

    //-----------------------------------------------
    private void showRulesIatiWent(RulesRequest rulesRequest, AllFlightInternationalIati allFlightInternationalIati) {
        UtilFragment.addNewFragment(getActivity().getSupportFragmentManager(),
                FragmentInternationalRouting.newInstance(allFlightInternationalIati, packageCompletedFlightInternational, rulesRequest), R.id.frame_Layout);
