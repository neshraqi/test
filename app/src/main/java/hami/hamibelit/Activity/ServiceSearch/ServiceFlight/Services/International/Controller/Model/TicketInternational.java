...
public class TicketInternational implements Parcelable {
    ...
    protected TicketInternational(Parcel in) {
        ...
        RegisterPassengerResponse = in.readParcelable(hami.hamibelit.Activity.ServiceSearch.ServiceFlight.Services.International.Controller.Model.RegisterPassengerResponse.class.getClassLoader());
    }
