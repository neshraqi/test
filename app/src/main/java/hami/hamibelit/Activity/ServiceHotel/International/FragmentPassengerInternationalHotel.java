...
import hami.hamibelit.Activity.ServiceHotel.International.Adapter.ListPassengerInternationalHotelListAdapter;
...
import hami.hamibelit.Activity.ServiceHotel.International.Controller.Model.PassengerInfoInternationalHotel;
...
import hami.hamibelit.Activity.ServiceHotel.International.Controller.Model.RoomPassengerInfoInternationalHotel;
import hami.hamibelit.Activity.ServiceHotel.International.Controller.Model.RowTypeHotelPassenger;
...
import hami.hamibelit.Const.RespinaConst;
                        ...
                        public void onSuccessResultSearch(final RegisterPassengerInternationalHotelResponse result) {
                            if (getActivity() != null) {
                                getActivity().runOnUiThread(new Runnable() {
                                    ...
                                    public void run() {
                                        alertDialog.cancel();
                                        UtilFragment.addNewFragment(getActivity().getSupportFragmentManager(), FragmentBookingInternationalHotel.newInstance(hotelDetailResponse, result));
                                    }
                                });
