...
public class PastPurchasesListFlightBusPassengerAdapter extends RecyclerView.Adapter<PastPurchasesListFlightBusPassengerAdapter.MyViewHolder> {

    private ArrayList<PassengerFlightDomestic> listItem;
    private Context context;
    private SelectItemList<PassengerFlightDomestic> selectItemList;
    private static final String TAG = "PastPurchasesListFlightBusPassengerAdapter";
    //-----------------------------------------------
    public PastPurchasesListFlightBusPassengerAdapter(Context context,
    ...
    //-----------------------------------------------
    @Override
    public PastPurchasesListFlightBusPassengerAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
