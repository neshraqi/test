package hami.hamibelit.Activity.PastPurchases;
...
import hami.hamibelit.Activity.Authentication.SignUpActivity;
import hami.hamibelit.Activity.PastPurchases.Adapter.PastPurchasesListBusAdapter;
import hami.hamibelit.Activity.PastPurchases.Adapter.PastPurchasesListFlightDomesticAdapter;
import hami.hamibelit.Activity.PastPurchases.Adapter.PastPurchasesListFlightInternationalAdapter;
import hami.hamibelit.Activity.PastPurchases.Adapter.PastPurchasesListTrainAdapter;
import hami.hamibelit.Activity.PastPurchases.Bus.ShowDetailsTicketBusActivity;
import hami.hamibelit.Activity.PastPurchases.DomesticFlight.ShowDetailsTicketFlightDomesticActivity;
import hami.hamibelit.Activity.PastPurchases.InternationalFlight.ShowDetailsTicketFlightInternationalActivity;
import hami.hamibelit.Activity.PastPurchases.Model.PurchasesBus;
...
import hami.hamibelit.Activity.PastPurchases.Model.PurchasesTrain;
import hami.hamibelit.Activity.PastPurchases.Model.PurchasesTrainResponse;
import hami.hamibelit.Activity.PastPurchases.Train.ShowDetailsTicketTrainActivity;
import hami.hamibelit.Activity.ServiceSearch.MainServicesSearchMaterialFragment;
...
import hami.hamibelit.Util.PaginationScrollListener;
...
public class PastPurchasesServicesMaterialFragment extends Fragment {
    ...
    private void setupTab(final View view) {
        ...
        int index = 0;
        Integer[] tabIcons = new Integer[3];
        Integer[] tabTitle = new Integer[3];
        ...
        ArrayList<Integer> integersIcon = new ArrayList<Integer>(Arrays.asList(tabIcons));
        ArrayList<Integer> integersTitle = new ArrayList<Integer>(Arrays.asList(tabTitle));
