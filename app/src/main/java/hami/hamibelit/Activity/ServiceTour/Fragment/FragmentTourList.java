...
import hami.hamibelit.Activity.ServiceTour.Adapter.TourListAdapter;
import hami.hamibelit.Activity.ServiceTour.Controller.Model.SearchTourRequest;
import hami.hamibelit.Activity.ServiceTour.Controller.Model.TourItem;
...
public class FragmentTourList extends Fragment {
    ...
    private SelectItemList<TourItem> tourItemSelectItemList = new SelectItemList<TourItem>() {
        ...
        public void onSelectItem(TourItem object, int position) {
            UtilFragment.addNewFragment(getActivity().getSupportFragmentManager(), FragmentTourDetail.newInstance(object.getId(), object.getName()));
        }
    };
}
