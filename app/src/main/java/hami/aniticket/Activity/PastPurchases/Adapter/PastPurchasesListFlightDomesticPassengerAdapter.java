...
public class PastPurchasesListFlightDomesticPassengerAdapter extends RecyclerView.Adapter<PastPurchasesListFlightDomesticPassengerAdapter.MyViewHolder> {

    private ArrayList<PassengerFlightDomestic> listItem;
    private Context context;
    private SelectItemList<PassengerFlightDomestic> selectItemList;
    private static final String TAG = "PastPurchasesListFlightDomesticPassengerAdapter";
    //-----------------------------------------------
    public PastPurchasesListFlightDomesticPassengerAdapter(Context context,
    ...
    //-----------------------------------------------
    @Override
    public PastPurchasesListFlightDomesticPassengerAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(final MyViewHolder viewHolder, final int position) {
        ...
        viewHolder.txtPrice.setText(getFinalPrice(passengerInfo.getFinalprice()));
