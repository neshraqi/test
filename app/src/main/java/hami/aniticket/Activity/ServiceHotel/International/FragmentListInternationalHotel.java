...
import hami.aniticket.Activity.ServiceHotel.International.Adapter.NewInternationalHotelListAdapter;
...
import hami.aniticket.Activity.ServiceHotel.International.Dialog.NewDesignFilterInternationalHotelFragmentDialog;
    ...
    SelectItemList<InternationalHotel> selectItemListHotelInternational = new SelectItemList<InternationalHotel>() {
        ...
        public void onSelectItem(InternationalHotel object, int index) {
            UtilFragment.addNewFragment(getActivity().getSupportFragmentManager(),
                    FragmentDetailInternationalHotel.newInstance(hotelSearchRequestJson, hotelSearchRequest, object));
        }
    };
    //-----------------------------------------------
}
