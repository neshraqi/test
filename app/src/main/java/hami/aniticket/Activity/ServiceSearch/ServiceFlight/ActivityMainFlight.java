package hami.aniticket.Activity.ServiceSearch.ServiceFlight;
...
import hami.aniticket.Activity.ServiceSearch.ServiceFlight.Services.Domestic.Fragment.FragmentFinalBookingFlightDomestic;
import hami.aniticket.Activity.ServiceSearch.ServiceFlight.Services.Domestic.Fragment.FragmentListWentDomestic;
...
import hami.aniticket.Activity.ServiceSearch.ServiceFlight.Services.International.Fragment.FragmentFinalBookingFlightInternational;
import hami.aniticket.Activity.ServiceSearch.ServiceFlight.Services.International.Fragment.FragmentListWentInternational;
...
public class ActivityMainFlight extends AppCompatActivity {
    ...
    private void initialComponentActivity() {
        ...
        timer();
        if (hasInternational)
            UtilFragment.changeFragment(getSupportFragmentManager(), FragmentListWentInternational.newInstance(flightRequest));
        else
            UtilFragment.changeFragment(getSupportFragmentManager(), FragmentListWentDomestic.newInstance(domesticRequest));
    }
