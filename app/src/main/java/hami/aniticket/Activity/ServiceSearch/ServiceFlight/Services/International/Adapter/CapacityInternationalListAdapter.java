...
import hami.aniticket.Activity.ServiceSearch.ServiceFlight.Services.International.Controller.Model.BaggageInfo;
...
public class CapacityInternationalListAdapter extends RecyclerView.Adapter<CapacityInternationalListAdapter.MyViewHolder> {
    ...
    //-----------------------------------------------
    @Override
    public CapacityInternationalListAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
