...
public class TicketInternational implements Parcelable {
    ...
    protected TicketInternational(Parcel in) {
        ...
        RegisterPassengerResponse = in.readParcelable(hami.aniticket.Activity.ServiceSearch.ServiceFlight.Services.International.Controller.Model.RegisterPassengerResponse.class.getClassLoader());
    }
