package hami.aniticket.Activity.ServiceSearch.ServiceFlight.Services.Domestic.Fragment;
...
import hami.aniticket.Activity.ServiceSearch.ServiceFlight.Services.Domestic.Adapter.NewDomesticListAdapter;
...
import hami.aniticket.Activity.ServiceSearch.ServiceFlight.Services.Domestic.Controller.Presenter.DomesticApi;
import hami.aniticket.Activity.ServiceSearch.ServiceFlight.Services.Domestic.Controller.Presenter.ResultSearchDomesticPresenter;
import hami.aniticket.Activity.ServiceSearch.ServiceFlight.Services.Domestic.Controller.Presenter.SelectItemFlightDomestic;
import hami.aniticket.Activity.ServiceSearch.ServiceFlight.Services.Domestic.Dialog.NewDesignFilterFlightDomesticFragmentDialog;
...
public class FragmentListWentDomestic extends Fragment {
    ...
    SelectItemFlightDomestic selectItemFlightDomestic = new SelectItemFlightDomestic() {
        ...
        public void onSelectItemFlight(DomesticFlight domesticFlight) {
            UtilFragment.addNewFragment(getActivity().getSupportFragmentManager(), FragmentDomesticDetails.newInstance(domesticFlight, domesticRequest));
        }
    };
