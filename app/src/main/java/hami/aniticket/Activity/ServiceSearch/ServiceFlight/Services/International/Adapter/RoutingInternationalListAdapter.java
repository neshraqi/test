...
import hami.aniticket.Activity.ServiceSearch.ServiceFlight.Services.International.Controller.Presenter.SelectItemShowRoutingFlightInternational;
...
public class RoutingInternationalListAdapter extends RecyclerView.Adapter<RoutingInternationalListAdapter.MyViewHolder> {
    ...
    //-----------------------------------------------
    @Override
    public RoutingInternationalListAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a layout
