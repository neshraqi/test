...
public class RegisterPassengerResponse implements Parcelable {
    ...
    protected RegisterPassengerResponse(Parcel in) {
        msg = in.readString();
        code = in.readInt();
        RegisterPassengerData = in.readParcelable(hami.aniticket.Activity.ServiceSearch.ServiceFlight.Services.International.Controller.Model.RegisterPassengerData.class.getClassLoader());
    }
