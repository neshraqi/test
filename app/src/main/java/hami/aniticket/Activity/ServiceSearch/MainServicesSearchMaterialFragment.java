package hami.aniticket.Activity.ServiceSearch;
...
import hami.aniticket.Activity.SearchBarService;
...
import hami.aniticket.Activity.ServiceHotel.SearchPlaceHotelActivity;
...
import hami.aniticket.Activity.ServiceSearch.ServiceFlight.SearchCountryActivity;
...
import hami.aniticket.Activity.ServiceSearch.ServiceTrain.SearchPlaceTrainActivity;
...
import hami.aniticket.MainActivityMaterialService;
...
public class MainServicesSearchMaterialFragment extends Fragment {
    ...
    private void setupService(final View view) {
        ...
        LinearLayout layoutTour = view.findViewById(R.id.layoutTour);
        LinearLayout layoutHotel = view.findViewById(R.id.layoutHotel);
        LinearLayout layoutBus = view.findViewById(R.id.layoutBus);
        LinearLayout layoutTrain = view.findViewById(R.id.layoutTrain);
        LinearLayout layoutFlight = view.findViewById(R.id.layoutFlight);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.layoutTour:
                    startActivity(new Intent(getActivity(), MainActivityMaterialService.class));
                    break;
