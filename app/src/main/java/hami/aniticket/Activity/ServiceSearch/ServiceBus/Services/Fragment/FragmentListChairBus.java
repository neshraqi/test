...
import hami.aniticket.Activity.ServiceSearch.ServiceBus.Services.Controller.Model.RegisterBusRequest;
...
import hami.aniticket.Activity.ServiceSearch.ServiceBus.Services.Controller.Model.SeatResponse;
import hami.aniticket.Activity.ServiceSearch.ServiceBus.Services.Controller.Model.SeatRow;
import hami.aniticket.Activity.ServiceSearch.ServiceBus.Services.Controller.Presenter.BusApi;
import hami.aniticket.Activity.ServiceSearch.ServiceBus.Services.Controller.Presenter.SeatChairBusPresenter;
import hami.aniticket.Activity.ServiceSearch.ServiceBus.View.SelectChairListener;
import hami.aniticket.Activity.ServiceSearch.ServiceBus.View.ToolsBusChair;
                        ...
                        public void onSuccessResultSearch(final BusTicketInformation result) {
                            if (getActivity() != null) {
                                getActivity().runOnUiThread(new Runnable() {
                                    ...
                                    public void run() {
                                        alertDialog.cancel();
                                        UtilFragment.addNewFragment(getActivity().getSupportFragmentManager(), FragmentReserveBus.newInstance(result, searchBusResponse));
