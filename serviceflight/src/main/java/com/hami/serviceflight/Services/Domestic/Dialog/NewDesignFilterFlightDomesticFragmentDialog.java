package com.hami.serviceflight.Services.Domestic.Dialog;
...
public class NewDesignFilterFlightDomesticFragmentDialog extends AAH_FabulousFragment {
    ...
    public final static String FILTER_CATEGORY_FLIGHT_DOMESTIC_TYPE = "fctt";
    public final static String FILTER_CATEGORY_TIME_TAKE_OFF = "fctto";
    public final static String FILTER_CATEGORY_AIRLINE = "fctc";
    ...
    private static final String TAG = "NewDesignFilterFlightDomesticFragmentDialog";
    //-----------------------------------------------
    public static NewDesignFilterFlightDomesticFragmentDialog newInstance(Callbacks callbacks) {
        NewDesignFilterFlightDomesticFragmentDialog.callbacks = callbacks;
        NewDesignFilterFlightDomesticFragmentDialog mff = new NewDesignFilterFlightDomesticFragmentDialog();
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            airline = (HashMap<String, String>) savedInstanceState.getSerializable("airline");
    ...
    public void onSaveInstanceState(Bundle outState) {
        if (outState != null) {
            outState.putSerializable("airline", airline);
    ...
    //-----------------------------------------------
    public void setFlights(HashMap<String, String> airline) {
        try {
    ...
    public void setupDialog(Dialog dialog, int style) {
        ...
        //if (contentView == null)
        contentView = View.inflate(getContext(), R.layout.fragment_domestic_flight_dialog_filter_view, null);
        resetFilterView();
    ...
    private void resetFilterView() {
        ...
        sort(rl_content);
        price(rl_content);
        setTypeFlight(rl_content);
        setupTimeTakeOff(rl_content);
        setupFlightAirline(rl_content);
    ...
    private void sort(View contentView) {
        ...
        final ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(getActivity(), R.array.sortDomesticFlight, R.layout.row_item_spinner_train_white);
    ...
    //-----------------------------------------------
    private void setTypeFlight(View contentView) {
        ...
        listTypeTrain.add("چارتری");
        listTypeTrain.add("سیستمی");
        for (int index = 0; index < listTypeTrain.size(); index++) {
            final CheckBox checkBox = new CheckBox(getActivity());
            checkBox.setTag(index);
            Integer tag = (Integer) checkBox.getTag();
            if (applied_filters != null &&
                    applied_filters.get(FILTER_CATEGORY_FLIGHT_DOMESTIC_TYPE) != null &&
                    applied_filters.get(FILTER_CATEGORY_FLIGHT_DOMESTIC_TYPE).contains(String.valueOf(tag))) {
                checkBox.setCheck(true);
            } else {
            ...
            checkBox.setCallBack(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                    if (isChecked)
                        addToSelectedMap(FILTER_CATEGORY_FLIGHT_DOMESTIC_TYPE, String.valueOf(checkBox.getTag()));
                    else
                        removeFromSelectedMap(FILTER_CATEGORY_FLIGHT_DOMESTIC_TYPE, String.valueOf(checkBox.getTag()));
    ...
    //-----------------------------------------------
    private void setupFlightAirline(View contentView) {
        LinearLayout linearLayout = (LinearLayout) contentView.findViewById(R.id.layoutAirline);
        Iterator<Map.Entry<String, String>> iterator = airline.entrySet().iterator();
