...
public class TicketInternational implements Parcelable {
    ...
    private com.hami.serviceflight.Services.International.Controller.Model.RegisterPassengerResponse RegisterPassengerResponse;
    //-----------------------------------------------
    ...
    public TicketInternational(OutBound outBound, OutBound return_, com.hami.serviceflight.Services.International.Controller.Model.RegisterPassengerResponse registerPassengerResponse) {
    ...
    protected TicketInternational(Parcel in) {
        ...
        RegisterPassengerResponse = in.readParcelable(RegisterPassengerResponse.class.getClassLoader());
    }
    ...
    public com.hami.serviceflight.Services.International.Controller.Model.RegisterPassengerResponse getRegisterPassengerResponse() {
