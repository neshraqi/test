...
import com.hami.servicehotel.Domestic.FragmentFinalBookingDomesticHotel;
import com.hami.servicehotel.Domestic.FragmentListDomesticHotel;
import com.hami.servicehotel.International.Controller.Model.InternationalHotelSearchRequest;
import com.hami.servicehotel.International.FragmentBookingInternationalHotel;
import com.hami.servicehotel.International.FragmentListInternationalHotel;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            if (getIntent().hasExtra(InternationalHotelSearchRequest.class.getName())) {
                ...
                setContentView(R.layout.activity_servicehotel_main_ltr);
                ...
                setContentView(R.layout.activity_servicehotel_main);
