...
import com.hami.common.Util.UtilMap;
...
import com.hami.servicehotel.International.Adapter.SlidingImageAdapter;
import com.hami.servicehotel.International.Controller.InternationalHotelApi;
import com.hami.servicehotel.International.Controller.Model.HotelDetailResponse;
import com.hami.servicehotel.International.Controller.Model.HotelInfo;
import com.hami.servicehotel.International.Controller.Model.HotelMoreInfoRoom;
import com.hami.servicehotel.International.Controller.Model.HotelMoreInfoRoomObject;
...
import com.hami.servicehotel.International.Controller.Model.RoomInfo;
                    ...
                    for (int index = 0; index < rooms.size(); index++) {
                        ...
                        btnSelectHotelRoom.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                UtilFragment.addNewFragment(getActivity().getSupportFragmentManager(), FragmentPassengerInternationalHotel.newInstance(hotelDetailResponse, indexSelected), R.id.frame_Layout);
                            }
                        });
...
//                            }
            ...
            btnFullFeatures.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    UtilFragment.addNewFragment(getActivity().getSupportFragmentManager(), FragmentFullDetailInternationalHotel.newInstance(hotelDetailResponse), R.id.frame_Layout);
                }
            });
