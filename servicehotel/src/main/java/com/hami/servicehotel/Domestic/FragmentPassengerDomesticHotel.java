...
import com.hami.serviceflight.Services.International.Controller.Presenter.NationalCodePresenter;
...
import com.hami.servicehotel.Domestic.Controller.Model.DomesticHotelPreBookingRequest;
import com.hami.servicehotel.Domestic.Controller.Model.DomesticHotelPreBookingResponse;
import com.hami.servicehotel.Domestic.Controller.Model.DomesticHotelRegisterPassengerRequest;
import com.hami.servicehotel.Domestic.Controller.Model.DomesticHotelRegisterPassengerResponse;
import com.hami.servicehotel.International.Adapter.ListPassengerInternationalHotelListAdapter;
...
//            reserveId = savedInstanceState.getString("reserveId");
    ...
    private void getInfo(String nationalCode) {
        new DomesticHotelApi(getActivity()).getInfoByNationalCode(nationalCode, new NationalCodePresenter() {
            @Override
            public void onStart() {
            ...
            public void onSuccessResultSearch(final DomesticHotelRegisterPassengerResponse result) {
                if (getActivity() != null) {
                    getActivity().runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            UtilFragment.addNewFragment(getActivity().getSupportFragmentManager(), FragmentFinalBookingDomesticHotel.newInstance(result), R.id.frame_Layout);
                        }
                    });
                }
            }
