...
import com.hami.servicehotel.Domestic.Adapter.NewDomesticHotelListAdapter;
...
import com.hami.servicehotel.Domestic.dialog.NewDesignFilterDomesticHotelFragmentDialog;
    ...
    SelectItemList<DomesticHotel> domesticHotelSelectItemList = new SelectItemList<DomesticHotel>() {
        ...
        public void onSelectItem(DomesticHotel object, int index) {
            ...
            UtilFragment.addNewFragment(getActivity().getSupportFragmentManager(),
                    FragmentDetailDomesticHotel.newInstance(domesticHotelSearchRequest), R.id.frame_Layout);
        }
    };
    //-----------------------------------------------
}
