package com.hami.servicehotel.Domestic.dialog;
...
import com.hami.common.View.CheckBoxRateRtl;
...
public class NewDesignFilterDomesticHotelFragmentDialog extends AAH_FabulousFragment {
    ...
    //-----------------------------------------------
    public static NewDesignFilterDomesticHotelFragmentDialog newInstance(Callbacks callbacks) {
        NewDesignFilterDomesticHotelFragmentDialog.callbacks = callbacks;
        NewDesignFilterDomesticHotelFragmentDialog mff = new NewDesignFilterDomesticHotelFragmentDialog();
    ...
    public void setupDialog(Dialog dialog, int style) {
        contentView = View.inflate(getContext(), R.layout.fragment_domestic_hotel_dialog_filter_view, null);
        resetFilterView();
    ...
    private void sort(View contentView) {
        ...
        final ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(getActivity(), R.array.sortDomesticHotel, R.layout.row_item_spinner_train_white);
    ...
    private void setupHotelClass(View contentView) {
        ...
        for (int index = 0; index < classTypeHotel.size(); index++) {
            final CheckBoxRateRtl checkBox = new CheckBoxRateRtl(getActivity());
            checkBox.setTag(classTypeHotel.get(index));
            ...
            if (rate == 0) {
                checkBox.showText(getString(R.string.noStars));
            } else {
