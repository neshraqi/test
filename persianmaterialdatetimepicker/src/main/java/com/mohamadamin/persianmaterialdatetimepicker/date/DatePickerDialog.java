...
public class DatePickerDialog extends DialogFragment implements
    ...
    private static final int DEFAULT_END_YEAR = 1600;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mSelectedMonthTextView.setTypeface(TypefaceHelper.get(getActivity(), "Roboto-Medium"));
        mYearView.setTypeface(TypefaceHelper.get(getActivity(), "Roboto-Medium"));
        int listPosition = -1;
        ...
        okButton.setTypeface(TypefaceHelper.get(activity, "iransans_bold"));
    ...
    public void setPlaceFlight(String fromPlace,String toPlace) {
