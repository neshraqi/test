...
public abstract class MonthView extends View {
    ...
    protected static int MINI_DAY_PRICE_TEXT_SIZE;
    ...
    protected Paint mMonthPriceDayPaint;
    ...
    public MonthView(Context context, AttributeSet attr, DatePickerController controller) {
        ...
        if (darkTheme) {
            ...
            mMonthDayTextColor = res.getColor(R.color.mdtp_blue);
        ...
        mMonthTitleColor = res.getColor(R.color.mdtp_blue);

        mStringBuilder = new StringBuilder(50);

        MINI_DAY_NUMBER_TEXT_SIZE = res.getDimensionPixelSize(R.dimen.mdtp_day_number_size);
        MINI_DAY_PRICE_TEXT_SIZE = res.getDimensionPixelSize(R.dimen.mdtp_day_Price_size);
    ...
    protected void initView() {
        ...
        mMonthTitlePaint.setTypeface(TypefaceHelper.get(getContext(), "iransans_bold"));
        ...
        mMonthDayLabelPaint.setTypeface(TypefaceHelper.get(getContext(), "iransans_bold"));
        ...
        mMonthNumPaint.setTypeface(TypefaceHelper.get(getContext(), "iransans_bold"));
        mMonthNumPaint.setStyle(Style.FILL);
        mMonthNumPaint.setTextAlign(Align.CENTER);
        mMonthNumPaint.setFakeBoldText(false);

        mMonthPriceDayPaint = new Paint();
        mMonthPriceDayPaint.setAntiAlias(true);
        mMonthPriceDayPaint.setTextSize(MINI_DAY_PRICE_TEXT_SIZE);
        mMonthPriceDayPaint.setTypeface(TypefaceHelper.get(getContext(), "iran_sans_normal"));
        mMonthPriceDayPaint.setColor(Color.rgb(245, 131, 87));
        mMonthPriceDayPaint.setStyle(Style.FILL);
        mMonthPriceDayPaint.setTextAlign(Align.CENTER);
        mMonthPriceDayPaint.setFakeBoldText(false);
    }
