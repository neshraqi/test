...
import com.hami.servicebus.Services.Fragment.FragmentListWentBus;
import com.hami.servicebus.Services.Fragment.FragmentReserveBus;
...
public class ActivityMainBus extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_servicebus_main);
        try {
