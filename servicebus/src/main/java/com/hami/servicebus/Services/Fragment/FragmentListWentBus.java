...
import com.hami.servicebus.Dialog.NewDesignFilterBusFragmentDialog;
import com.hami.servicebus.R;
import com.hami.servicebus.Services.Controller.Adapter.ResultSearchBusListAdapter;
...
import com.hami.servicebus.Services.Controller.Presenter.BusWarehouse;
import com.hami.servicebus.Services.Controller.Presenter.ResultSearchBusPresenter;
import com.hami.servicebus.Services.Controller.Presenter.SelectItemBus;
...
//    };
    ...
    SelectItemBus selectItemBus = new SelectItemBus() {
        ...
        public void onSelectItemBus(SearchBusResponse searchBusResponse) {
            ...
            UtilFragment.addNewFragment(getActivity().getSupportFragmentManager(), FragmentListChairBus.newInstance(searchBusResponse, searchBusRequest), R.id.frame_Layout);
        }
    };
