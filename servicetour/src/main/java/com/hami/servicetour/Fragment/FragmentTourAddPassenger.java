...
import com.hami.servicetour.Adapter.BottomSheetLayoutPriceTour;
import com.hami.servicetour.Adapter.OnSelectItemPassengerTourListener;
import com.hami.servicetour.Adapter.PassengerTourListAdapter;
...
import com.hami.servicetour.Controller.Model.BookingTourUserData;
                                    ...
                                    public void run() {
                                        ...
                                        if (result != null) {
                                            UtilFragment.addNewFragment(getActivity().getSupportFragmentManager(),
                                                    FragmentTourFinalBooking.newInstance(result), R.id.frame_Layout);
                                        }
                                    }
                                });
                            }
