...
public class RegisterPassengerResponse implements Parcelable {
    ...
    protected RegisterPassengerResponse(Parcel in) {
        msg = in.readString();
        code = in.readInt();
        RegisterPassengerData = in.readParcelable(hami.hamibelit.Activity.ServiceSearch.ServiceFlight.Services.International.Controller.Model.RegisterPassengerData.class.getClassLoader());
    }
