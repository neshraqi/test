...
public class ToolsPersianCalendar implements Serializable {
    ...
    private static String persian_month_names[] = {"", "فروردین", "اردیبهشت", "خرداد",
    ...
    public static String getPersianMonthString(Date dt) {
        GregorianCalendar gc = new GregorianCalendar();
        gc.setTime(dt);
        int gregYear = gc.get(Calendar.YEAR);
        int gregMonth = gc.get(Calendar.MONTH) + 1;
    ...
    public static Calendar getGregorianCalendar(ToolsPersianCalendar jalali) {
     ...
     * Constructor
     */
    public ToolsPersianCalendar(Calendar gregorian) {
     ...
     */
    public ToolsPersianCalendar(String jalaliString) {
    ...
    public ToolsPersianCalendar(ToolsPersianCalendar jalali) {
        setPersainCalendarWithJalali(jalali.getYear(), jalali.getMonth(), jalali.getDay(),
                jalali.getHour(), jalali.getMinute(), jalali.getSecond());
    }

    public ToolsPersianCalendar(int jalaliyear, int jalalimonth, int jalaliday) {
        setPersainCalendarWithJalali(jalaliyear, jalalimonth, jalaliday);
    }

    public ToolsPersianCalendar(int jalaliyear, int jalalimonth, int jalaliday, int jalalihour,
    ...
    public boolean isEqual(ToolsPersianCalendar jalali) {
    ...
    public int compareTo(ToolsPersianCalendar jalali) {
