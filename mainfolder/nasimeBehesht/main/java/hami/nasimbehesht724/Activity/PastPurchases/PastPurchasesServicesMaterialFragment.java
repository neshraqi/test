package hami.mainapp.Activity.PastPurchases;
...
import hami.mainapp.Activity.Authentication.SignUpActivity;
import hami.mainapp.Activity.PastPurchases.Adapter.PastPurchasesListBusAdapter;
import hami.mainapp.Activity.PastPurchases.Adapter.PastPurchasesListFlightDomesticAdapter;
import hami.mainapp.Activity.PastPurchases.Adapter.PastPurchasesListFlightInternationalAdapter;
import hami.mainapp.Activity.PastPurchases.Adapter.PastPurchasesListTrainAdapter;
import hami.mainapp.Activity.PastPurchases.Bus.ShowDetailsTicketBusActivity;
import hami.mainapp.Activity.PastPurchases.DomesticFlight.ShowDetailsTicketFlightDomesticActivity;
import hami.mainapp.Activity.PastPurchases.InternationalFlight.ShowDetailsTicketFlightInternationalActivity;
...
import hami.mainapp.Activity.PastPurchases.Model.PurchasesFlightInternational;
...
import hami.mainapp.Activity.PastPurchases.Train.ShowDetailsTicketTrainActivity;
...
import hami.mainapp.Util.PaginationScrollListener;
...
//            tabTitle[index] = R.string.airPlanDomestic;
    ...
    private void showSearchPage() {
        UtilFragment.changeFragment(getActivity().getSupportFragmentManager(), MainServicesSearchMaterialFragment.newInstance(accessStatusResponse, serviceId));
